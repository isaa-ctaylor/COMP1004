...
function updateGraph() {
    ...
    document.getElementById('income-bar').style.width = `${(totals.income / (totals.income + totals.expenses)) * 100}%`;
    document.getElementById('expenses-bar').style.width = `${(totals.expenses / (totals.income + totals.expenses)) * 100}%`;
}
